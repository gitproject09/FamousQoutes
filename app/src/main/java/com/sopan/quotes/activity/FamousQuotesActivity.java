...
import com.sopan.quotes.adapter.QuotesAdapter;
import com.sopan.quotes.R;

public class FamousQuotesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void saveScrollPositon() {
        if (lv != null) {
            int y = ((LinearLayoutManager) lv.getLayoutManager()).findFirstCompletelyVisibleItemPosition();
            SharedPreferences pref = getSharedPreferences(getPackageName(), MODE_PRIVATE);
    ...
    public void gotoWebsite(View v) {
        String url = "http://github.com/gitproject09";
